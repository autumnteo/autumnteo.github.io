        ...
        <div className="text-left py-0 mt-2 my-0 flex-66 sm:pl-10 sm:ml-2">
          <Fade>
            ...
            <div className="text-base code py-2 px-4">
              ...
              <p>
                I'm currently a penultimate Information Systems studying in SMU. 
                During my course of study, i have been involved in social analytics 
                research project have also been a teaching assistant for numerous modules.
              </p>
              <p>
                In my free time, i like to explore and learn different
                technologies. I learnt how to use React and used it to
                built this website!
              </p>
            </div>
